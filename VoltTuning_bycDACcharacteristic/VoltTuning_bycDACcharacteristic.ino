/*
   タイトル：MEMS触覚センサ用アンプ(秋田アンプ)の自動チューニングコード　PCなどとのシリアル通信用
   ...
   変更履歴：2021 06/04 : ver1.0
            ...
            2021 06/18 : ver1.1 軸が死んでる時にする処理を改良．軸が死んでいても3軸の値が出力されるように．
...
void setup() {
  ...
  int TuneEnd = 1;
  int init_v = 400;//in 12bit value 4096=5V, 0=0V.開始直後はアンプからの出力が上限値になるようにする
  int cnt = 0;
